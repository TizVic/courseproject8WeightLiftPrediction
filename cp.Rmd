...
```{r lda, message=FALSE, warning=FALSE, cache=TRUE}
# LDA
ltTRlda <- ltTR
ltCVlda <- ltCV
# Train on ltTR set
...
### Linear kernel SVM
```{r linearSVM, cache=TRUE, message=FALSE, warning=FALSE}
## SVM Linear Kernel
ltTRsvm <- ltTR
ltCVsvm <- ltCV
linTime <- system.time(
...
### Radial kernel SVM
```{r radialSVM, cache=TRUE, message=FALSE, warning=FALSE}
## SVM Radial Kernel
...
```{r boost, cache=TRUE, message=FALSE, warning=FALSE}
## Boosting with trees
ltTRgbm <- ltTR
ltCVgbm <- ltCV
gbmTime <- system.time(
